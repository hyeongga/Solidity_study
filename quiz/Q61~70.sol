...
// 64. 지갑 주소를 넣으면 5개의 4bytes로 분할하여 반환해주는 함수를 구현하세요.
    ...
    function Q64_3(address wallet) public pure returns (bytes4[5] memory) {
    ...
    /*  
        ...
        * 지갑주소 : 0x 5B38Da6a 701c5685 45dCfcB0 3FcB875f 56beddC4 
        5B38Da6a에서 5B를 2진수로 바꾸면,
        byte1 5B = uint8( 5B ) = (10진수)16 * 5 + 11 = (10진수)91 = (2진수)0101 1011
        
        * <<연산자 사용 : (10진수)<<(옮겨갈칸수)
        : 91 << 24
        uint32(0101 1011)     = 0000 0000 0000 0000 0000 0000 0101 1011 
        uint32(0101 1011)<<24 = 0101 1011 0000 0000 0000 0000 0000 0000

        * |연산자 사용
            0101 1011 0000 0000 0000 0000 0000 0000
            0000 0000 0011 1000 0000 0000 0000 0000
            0000 0000 0000 0000 1101 1010 0000 0000
            0000 0000 0000 0000 0000 0000 0110 1010
        ----------------------------------------------
            0101 1011 0011 1000 1101 1010 0110 1010
